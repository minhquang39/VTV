<template>
  <HomeSekeleton v-if="isLoading" />
  <div class="flex flex-col md:flex-row relative flex-wrap" v-if="!isLoading">
    <!-- Big New -->
...
<script setup>
import HomeSekeleton from '@/sekeleton/HomeSekeleton.vue';
